# FormFusion - Basic Input usage

This repository contains a simple example of using the Input component with built-in validation from the FormFusion [Library](https://www.corelabui.com/)
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/corelabui/basic-input-usage.git
   ```

2. Install dependencies:

   ```bash
   cd basic-input-usage
   npm install
   ```
